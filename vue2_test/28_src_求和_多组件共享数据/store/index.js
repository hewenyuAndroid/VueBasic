...
const mutations = {
    ...
    INCREAMENT_ODD(context, value) {
        console.log("perfrom vuex mutations INDREATE_ODD, context=", context, ",value=", value);
        state.sum += value;
    },

    ADD_PERSON(context, value) {
        console.log("perfrom vuex mutations ADD_PERSON, context=", context, ",value=", value);
